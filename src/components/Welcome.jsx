    ...
    <>
      <div className='flex flex-grow flex-col justify-center items-center h-screen bg-black text-white'>
        ...
        <div className='flex justify-center py-2 flex-col items-center w-fit'>
          <p className='py-3 text-xl'>Sign In to interact with your peers</p>
          <button className='bg-transparent bg-gradient-to-r from-purple-600 to-purple-400  py-3 w-full rounded-2xl font-bold text-xl'
